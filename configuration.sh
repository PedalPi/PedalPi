...
sudo apt-get install git python3-pip --no-install-recommends -y
mkdir ~/Desktop
...
# Compilar com essas libs -march=armv8-a+crc -mtune=cortex-a53 -mfpu=neon-fp-armv8 -mfloat-abi=hard
make
cd ~/Desktop
